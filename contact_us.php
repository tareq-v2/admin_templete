            ...
            <div class="container-fluid">
                <div class="content-form-wrapper">
                    ...
                    <div class="content-form">
                      <textarea id="summernote" name="contact_us"><?php  echo $fetch['contact_text']; ?></textarea>
                    </div>
                    <div class="submit-btn" style="text-align: center;margin-top: 20px;">
                         <input type="submit" name="contact_us_submit" value="Submit" class="btn btn-info">
                         <input type="submit" name="contact_us_update" value="Edit" class="btn btn-warning">
                    </div>
                </div>
            </div>
