                ...
                <div class="form-wrappper">
                    <div class="form-body">
                        ...
                        <div class="form-body-main">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Thana Name</b></label>
                                <input type="text" name="thana_name" class="form-control col-lg-5 col-md-5 col-12" placeholder="thana name">
                            </div>
                            <div class="form-group" style="text-align: center !important;">
                                <input type="submit" name="thana_add_btn" class="btn btn-success" value="Create">
                                <input type="submit" name="thana_view_btn" class="btn btn-warning" value="View">
                            </div>
                        </div>
                    </div>
                </div>
