        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <div class="container-fluid p-0">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="mb-0"> Add Product Weight</h4>
                            <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                                <li class="breadcrumb-item"><a href="index.php" class="default-color">Home</a></li>
                                <li class="breadcrumb-item active">Add Product Weight</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-wrappper">
                    <div class="form-body">
                        <div class="form-title">
                            <h3><b>Add Product Weight</b></h3>
                        </div>
                        <div class="form-body-main">
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Product Weight Name</b></label>
                                <input type="text" name="weight_name" class="form-control col-lg-5 col-md-5 col-12">
                            </div>
                            <div class="form-group" style="text-align: center !important;">
                                <input type="submit" name="create_weight_btn" class="btn btn-success" value="Create">
                                <input type="submit" name="show_weight_btn" class="btn btn-warning" value="View">
                            </div>
                        </div>
