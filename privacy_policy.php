        ...
        <main class="main-content">
            ...
            <div class="container-fluid">
                <div class="content-form-wrapper">
                    <div class="contentform-title">
                        <h3>Privacy & Policy</h3>
                    </div>
                    <div class="content-form">
                      <textarea id="summernote" name="privacy_text"><?php echo $fetch['privacy_text']; ?></textarea>
                    </div>
                    <div class="submit-btn" style="text-align: center;margin-top: 20px;">
                         <input type="submit" name="privacypolicy_submit" value="Submit" class="btn btn-info">
                         <input type="submit" name="privacypolicy_update" value="Edit" class="btn btn-warning">
                    </div>
                </div>
            </div>
