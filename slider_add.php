                ...
                <div class="content-form-wrapper">
                    ...
                    <div class="content-form">
                      <div class="form-group row">
                        ...
                        <input type="number" name="slider_picture_sl" class="form-control col-lg-5 col-md-5 col-12">
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-md-4 col-12"><b>Links</b></label>
                        <input type="text" name="slider_picture_url" class="form-control col-lg-5 col-md-5 col-12" placeholder="Ex:url">
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="submit-btn" style="text-align: center;margin-top: 20px;">
                         <input type="submit" name="slider_submit" value="Submit" class="btn btn-info">
                         <input type="submit" name="slider_view" value="View" class="btn btn-secondary">
                    </div>
                </div>
            </div>
