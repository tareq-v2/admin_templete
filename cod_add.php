        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <div class="container-fluid p-0">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="mb-0"> Create Catagorie</h4>
                            <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                                <li class="breadcrumb-item"><a href="index.php" class="default-color">Home</a></li>
                                <li class="breadcrumb-item active">Create Catagorie</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-wrappper">
                    <div class="form-body">
                        <div class="form-title">
                            <h3><b>Create Catagorie</b></h3>
                        </div>
                        <div class="form-body-main">
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Sl</b></label>
                                <input type="number" name="catagorie_sl" placeholder="Ex:01" class="form-control col-lg-5 col-md-5 col-12">
                            </div>
                            <div class="form-group row">
                               ...
                               <select class="form-control col-lg-5 col-md-5 col-12">
                                   ...
                                   <option value="">Dry Fish</option>
                                   <option value="">Food For Health</option>
                                   <option value="">Grocery</option>
                                   <option value="">Pickle & Chutney</option>
                                   <option value="">Fruits</option>
                               </select>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Catagorie Name</b></label>
                                <input type="text" name="catagorie_name" class="form-control col-lg-5 col-md-5 col-12">
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Item Image</b></label>
                                <input type="file" name="catagorie_img" class="form-control col-lg-5 col-md-5 col-12">
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Item Banner</b></label>
                                <input type="file" name="catagorie_banner" class="form-control col-lg-5 col-md-5 col-12">
                            </div>
                            <div class="form-group" style="text-align: center !important;">
                                <input type="submit" name="create_catagorie_btn" class="btn btn-success" value="Create">
                                <input type="submit" name="show_catagorie_btn" class="btn btn-warning" value="View">
                            </div>
                        </div>
                    </div>
                </div>
