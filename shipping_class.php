        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <div class="container-fluid p-0">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="mb-0"> Add Shipping Class</h4>
                ...
                <div class="form-wrappper">
                    <div class="form-body">
                        <div class="form-title">
                            <h3><b>Add Shipping Class</b></h3>
                        </div>
                        <div class="form-body-main">
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Shipping Name</b></label>
                                <input type="text" name="shippingClass_name" class="form-control col-lg-5 col-md-5 col-12" placeholder="shipping name">
                            </div>
                            <div class="form-group" style="text-align: center !important;">
                                <input type="submit" name="shippingClass_create_btn" class="btn btn-success" value="Create">
                                <input type="submit" name="view_shipping_class_btn" class="btn btn-warning" value="View">
                            </div>
                        </div>
                    </div>
                </div>
