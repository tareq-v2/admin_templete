                    ...
                    <div class="form-body">
                        ...
                        <div class="form-body-main">
                            <div class="form-group row">
                                ...
                                <input type="text" name="zone_name" class="form-control col-lg-5 col-md-5 col-12" placeholder="zone name">
                            </div>
                            <div class="form-group" style="text-align: center !important;">
                                <input type="submit" name="zone_create_btn" class="btn btn-success" value="Create">
                                <input type="submit" name="zone_view_btn" class="btn btn-warning" value="View">
                            </div>
                        </div>
                    </div>
                </div>
