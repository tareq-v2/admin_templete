                ...
                <div class="form-wrappper">
                    <div class="form-body">
                        <div class="form-title">
                            <h3><b>Add Item Type</b></h3>
                        </div>
                        <div class="form-body-main">
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Item Type Name</b></label>
                                <input type="text" name="item_type_name" class="form-control col-lg-5 col-md-5 col-12">
                            </div>
                            <div class="form-group" style="text-align: center !important;">
                                <input type="submit" name="create_itype_btn" class="btn btn-success" value="Create">
                                <input type="submit" name="show_itype_btn" class="btn btn-warning" value="View">
                            </div>
