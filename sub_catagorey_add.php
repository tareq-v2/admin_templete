        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <div class="container-fluid p-0">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="mb-0"> Create Sub Catagorie</h4>
                            <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                                <li class="breadcrumb-item"><a href="index.php" class="default-color">Home</a></li>
                                <li class="breadcrumb-item active">Create Sub Catagorie</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-wrappper">
                    <div class="form-body">
                        <div class="form-title">
                            <h3><b>Create Sub Catagorie</b></h3>
                        </div>
                        <div class="form-body-main">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Sub Catagorie Name</b></label>
                                <input type="text" name="sub_catagorie_name" class="form-control col-lg-5 col-md-5 col-12">
                            </div>
                            <div class="form-group" style="text-align: center !important;">
                                <input type="submit" name="create_subCatagorie_btn" class="btn btn-success" value="Create">
                                <input type="submit" name="show_subCatagorie_btn" class="btn btn-warning" value="View">
                            </div>
                        </div>
                    </div>
                </div>
