        ...
        <main class="main-content">
            ...
            <div class="page-title">
                <div class="container-fluid p-0">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="mb-0"> View Main Menu</h4>
                            <ol class="breadcrumb mb-0 pl-0 pt-1 pb-0">
                                <li class="breadcrumb-item"><a href="index.php" class="default-color">Home</a></li>
                                <li class="breadcrumb-item active">View Main Menu</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="back-menu">
                  <a href="main_menu_add.php" class="btn btn-outline-success">Add Main Menu</a>
                </div>
                ...
                <div class="admin-view-area">
                   <table class="table table-bordered table-hover table-stripped" style="text-align: center;">
                       <thead>
                           ...
                           $offset=($page - 1) * $limit;
                           $sql_select=$db->link->query("SELECT * FROM `main_menu` LIMIT $offset,$limit ");
                           ...
                           <tr>
                             ...
                             <td>
                               <a href="main_menu_edit.php?mainMenuid=<?php echo $fetch['id'] ?>" class="btn btn-outline-success">Edit</a>
                               <a href="main_menu_delete.php?mainMenuid=<?php echo $fetch['id'] ?>" class="btn btn-outline-danger">Delete</a>
                             </td>
                           </tr>
                           <?php
                             }
                ...
                <nav aria-label="...">
                  <ul class="pagination">
                  <?php
                  $sql1=$db->link->query("SELECT * FROM `main_menu`");
                  if(mysqli_num_rows($sql1) > 0)
                  {
                    ...
                    ?>
                    <li class="page-item">
                      <a class="page-link" href="view_main_menu.php?page=<?php echo ($page - 1); ?>">Previous</a>
                    </li>
                    <?php
                    }
                    ?>
                    ...
                    ?>
                      <li class="page-item <?php echo $active; ?>">
                        <a class="page-link" href="view_main_menu.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                      </li>
                    <?php
                    }
                    ?>
                    ...
                    ?>
                    <li class="page-item">
                      <a class="page-link" href="view_main_menu.php?page=<?php echo ($page + 1); ?>">Next</a>
                    </li>
                    <?php
                    }
                  }
